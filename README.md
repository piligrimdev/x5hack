...
Награда за выполненное задание начисляется в **баллах** (не в скидке) по тому же курсу, что и
...
`GET /receipts/economy`. Детали — в [`specs/007-cashback-points/`](specs/007-cashback-points/).
